window.translations_vi = {
    ...
    'outstanding_projects_eyebrow': 'DỰ ÁN NỔI BẬC',
    'outstanding_projects_title': 'Các Dự Án Đột Phá & Thành Công',
    'outstanding_projects_description': 'Khám phá những dự án tiêu biểu trong lĩnh vực EdTech, quản lý doanh nghiệp và phát triển sản phẩm, thể hiện sự đổi mới và hiệu quả trong công việc của tôi.',
    'featured_project1_title': 'IVS English Learners App',
    'featured_project1_desc': 'Nền tảng học Tiếng Anh tích hợp AI với Writing Grader và Speaking Partner, hỗ trợ cá nhân hóa lộ trình học.',
    'featured_project2_title': 'IELTS Station Center',
    'featured_project2_desc': 'Quản lý dự án toàn diện từ nghiên cứu thị trường, thi công đến vận hành trung tâm IELTS tại Long Thành.',
    ...
    'eco_sub': 'Hệ sinh thái số IVS cho trung tâm ngoại ngữ, đáp ứng mọi nhu cầu vận hành, đánh giá và học tập.',
    'eco1_platform': 'Nền tảng #1',
    'eco1_name': 'IVS CenterCare',
    'eco1_desc': 'Nền tảng quản trị tổng thể đồng bộ học viên, lịch học, học phí và báo cáo vận hành thời gian thực.',
    'eco1_f1': 'Quản lý học phí',
    'eco1_f2': 'Điểm danh số',
    'eco1_f3': 'Đồng bộ App phụ huynh',
    'eco1_f4': 'Lập lịch thông minh',
    'eco1_btn': 'Xem chi tiết',
    'eco2_platform': 'Nền tảng #2',
    'eco2_name': 'IVS Examia',
    'eco2_desc': 'Hệ thống đánh giá chuyên nghiệp cho trung tâm ngoại ngữ, hỗ trợ thi giữa kỳ, cuối kỳ và thi thử quốc tế.',
    'eco2_f1': 'Tự động chấm điểm',
    'eco2_f2': 'Phân tích năng lực',
    'eco2_f3': 'Ngân hàng đề thi',
    'eco2_f4': 'Chống gian lận',
    'eco2_btn': 'Xem chi tiết',
    'eco3_platform': 'Nền tảng #3',
    'eco3_name': 'ELearners',
    'eco3_desc': 'Ứng dụng tự học tương tác cho học sinh K-12 với lộ trình cá nhân hóa, kết nối trung tâm và gia đình.',
    'eco3_f1': 'Bài học game hóa',
    'eco3_f2': 'Phản hồi giọng nói AI',
    'eco3_f3': 'Theo dõi mục tiêu ngày',
    'eco3_f4': 'Hệ thống thưởng',
    'eco3_btn': 'Xem chi tiết',
    'eco4_platform': 'Nền tảng #4',
    'eco4_name': 'Testing Placement',
    'eco4_desc': 'Công cụ kiểm tra đầu vào chính xác, tối ưu xếp lớp.',
    'eco4_f1': 'Kiểm tra tự động',
    'eco4_f2': 'Phân loại trình độ',
    'eco4_f3': 'Kết quả tức thì',
    'eco4_f4': 'Xuất báo cáo',
    'eco4_btn': 'Xem chi tiết',
    'eco_sync_badge': 'Mô hình phần mềm đồng hành',
    'eco_sync_title': 'Công nghệ giúp trường hợp tác với IVS dễ dàng hơn bằng cách giải quyết các điểm đau quản trị nội bộ.',
    'eco_sync_f1': 'Cơ sở dữ liệu đám mây tập trung',
    'eco_sync_f2': 'Đồng bộ vệ tinh thời gian thực',
    // Expand/Collapse
    'section_expand': 'Mở rộng',
    'section_collapse': 'Thu gọn'
};
